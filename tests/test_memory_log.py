...
class TestDeferredReflection:
    ...
    def test_fetch_returns_valid_ticker(self):
        ...
        # akshare path is tried first; stub it to "no data" so the legacy
        # yfinance fallback below is the path under test (offline).
        with patch("tradingagents.dataflows.akshare_data.get_market_returns",
