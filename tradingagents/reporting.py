...
def write_report_tree(final_state: dict, ticker: str, save_path) -> Path:
    ...
    logger.debug("Writing report tree for ticker=%s to save_path=%s", ticker, save_path)
    try:
        ...
        logger.exception("Failed to write report tree for ticker=%s to save_path=%s", ticker, save_path)
        raise
